function switchSub(idx) {
  ...
  document.querySelectorAll('.sub-panel').forEach(function (p, i) {
    p.classList.toggle('active', i === idx);
  });
}
var completeChallenge2 = document.querySelector('.btn-main[href="./track-3.html"]');
if (completeChallenge2) {
  completeChallenge2.addEventListener('click', function () {
    localStorage.setItem('cq_challenge_2_complete', 'true');
  });
}
